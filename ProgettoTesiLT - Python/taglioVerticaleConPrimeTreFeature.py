#-----------------------------------------------------------------------------------------------------------------------
#-----------------------------------------------------------------------------------------------------------------------
#----------------------------TAGLIO VERTICALE CON SOLO PRIME FEATURES RILEVANTI-----------------------------------------
#-----------------------------------------------------------------------------------------------------------------------
#-----------------------------------------------------------------------------------------------------------------------
...
for feature in data.columns:
    if feature not in important_feature_name: #se la feature non è presente in important_feature_name la elimino
...
dataset_ridotto =  data # (solo le prime 3 feature più importanti) + (target)
